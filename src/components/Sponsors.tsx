                    ...
                    >
                        ...
                        <div className="px-8 py-4">
                            ...
                            <button
                                ...
                                className="mt-8 w-full py-2.5 bg-bg-primary/35 hover:bg-accent-pink/5 text-fg-primary hover:text-accent-pink rounded-lg font-medium transition-all border border-bg-border hover:border-accent-pink/45 animate-led active:scale-[0.98]"
                            >
                                Get Started
                            </button>
                        </div>
