            ...
            <div className="flex overflow-x-auto gap-2 p-3 no-scrollbar">
                {SPONSORS.map((s, i) => (
                    <a
                        ...
                        className="group shrink-0 w-44 border border-bg-border rounded-md px-3 py-2.5 hover:border-fg-muted hover:bg-bg-hover transition-all duration-150"
                    >
                ...
                <button
                    ...
                    className="shrink-0 w-44 border border-dashed border-bg-border rounded-md px-3 py-2.5 hover:border-fg-muted hover:bg-bg-hover transition-all duration-150 text-left"
                >
