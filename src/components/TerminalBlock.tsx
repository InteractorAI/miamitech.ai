...
export function Panel({ title, subtitle, children, className = '', action, noPadding = false }: PanelProps) {
    return (
        ...
        <div className={`bg-bg-card flex flex-col overflow-hidden ${className}`}>
            <div className="px-5 h-[52px] flex items-center justify-between gap-3 border-b border-bg-border min-w-0 bg-gradient-to-r from-accent-green/[0.03] to-transparent shrink-0">
