...
- To ship: push `main`. Vercel automatically deploys production from `main`; do not run a separate `npx vercel --prod` deployment. Confirm the production deploy aliases to `https://miamitech.ai`.
